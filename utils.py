...
class SuffixManager:
    ...
    def get_input_ids(self, adv_string=None):
        ...
        # target_slice = self._target_slice  # The slice indicating the target portion
        ...
        sliced_encoding = encoding.input_ids[self._target_slice.start:self._target_slice.stop]
        print(f"sliced_encoding of |start:stop| :{sliced_encoding}")

        sliced_encoding_suffix = encoding.input_ids[self._control_slice.start:self._control_slice.stop]
        print(f"|suffix_start:stop| :{sliced_encoding_suffix}")
