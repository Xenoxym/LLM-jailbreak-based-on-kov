...
def extract_suffix(data):
    idx = np.argmin([d['score'] for d in data])
...
def startKOV(csvFileName, model_name):
    ...
    results = test_transfer(fn_training_data, target_model, csvFileName, model_name, benchmark_indices=[89], temperature=0, verbose=True)
    # Print results
